<div style="padding: 2rem 1.5rem; max-width: 860px; margin: 0 auto;">
    <div class="page-header">
        <div class="page-header-text">
            <h1 class="page-title">Update Setoran Baru</h1>
    ...
    <form wire:submit="update" class="card" style="max-width: 900px;">
        ...
        <div class="card-footer" style="text-align: right;">
            <button type="submit" class="btn btn-primary btn-xl" wire:loading.attr="disabled">
                <span wire:loading.remove wire:target="update">SIMPAN SETORAN</span>
